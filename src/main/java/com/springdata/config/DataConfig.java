...
@EnableJpaRepositories(basePackages = {"com.springdata.model","com.springdata.repository"})
public class DataConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        emfb.setPackagesToScan("com.springdata.model", "com.springdata.repository");
